                ...
                <form id="invoice_form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <p class="text-muted small mb-3">If you allocate space here, the system will automatically update the booking for the client.</p>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <select name="event_space_id" id="event_space_id" class="form-control select2 event_space_id" style="width: 100%;">
                                    ...
                                    @foreach($event_spaces as $space)
                                        <option value="{{$space->id}}" @if($invoice->booking && $invoice->booking->event_space_id == $space->id) selected @endif>{{$space->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" name="width" id="width" class="form-control" placeholder="e.g. 3" value="{{ $invoice->booking ? $invoice->booking->width : '' }}">
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label for="length">Length (m)</label>
                                <input type="number" step="0.01" name="length" id="length" class="form-control" placeholder="e.g. 3" value="{{ $invoice->booking ? $invoice->booking->length : '' }}">
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label for="area_sqm">Total Area (m²)</label>
                                <input type="number" step="0.01" name="area_sqm" id="area_sqm" class="form-control" placeholder="e.g. 9" value="{{ $invoice->booking ? $invoice->booking->area_sqm : '' }}">
                            </div>
                        </div>
